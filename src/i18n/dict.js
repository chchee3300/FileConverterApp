...
export const dict = {
  en: {
    ...
    'settings.video.targetSize': 'Quick compress to under',
    'settings.video.targetSizeOff': 'Off',
    'settings.video.targetSizeCodecLocked': 'Codec is locked to H.264 while quick-compress is on, for reliable results under the target size.',
  ...
  'zh-TW': {
    ...
    'settings.video.targetSize': '快速壓縮到低於',
    'settings.video.targetSizeOff': '關閉',
    'settings.video.targetSizeCodecLocked': '快速壓縮開啟時，編碼器鎖定為 H.264，確保輸出可靠地低於目標大小。',
